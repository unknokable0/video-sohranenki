...
class AppSettings(context: Context) {
    ...
    fun smartChaptersCache(videoId: String): String? =
        prefs.getString("smart_chapters_v13_" + videoId, null)

    fun saveSmartChaptersCache(videoId: String, json: String) {
        prefs.edit().putString("smart_chapters_v13_" + videoId, json).apply()
    }

    fun clearSmartChaptersCache(videoId: String) {
        prefs.edit().remove("smart_chapters_v13_" + videoId).apply()
    }
